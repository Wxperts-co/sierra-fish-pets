          ...
          <div className="absolute inset-x-0 top-0 z-[3] flex h-full flex-col items-center justify-center px-4 text-center">
            <div className="flex flex-col items-center justify-center max-w-4xl">
              ...
              >
                ...
                <span className="flex items-center gap-0.5">
                  <span className="font-bold text-white md:bg-[linear-gradient(135deg,#003B73_0%,#005EA8_40%,#0077C8_75%,#1E8FD2_100%)] md:bg-clip-text md:text-transparent">
                    {service.name}
                  </span>
                </span>
              </nav>
              ...
              <div>
                <Link
                  href="/contact-us"
                  className="inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-[#005AA9] hover:bg-[#004b8d] text-white px-5 sm:px-8 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl text-xs sm:text-base font-bold shadow-lg shadow-blue-500/20 hover:scale-105 active:scale-95 transition-all"
                >
                  {isWaterTesting
                    ? "Get Free Water Testing"
                    : isFishOfMonth
                    ? "Join Fish of the Month Club"
                    : isNailWingTrim
                    ? "Schedule Pet Trim"
                    : "Book a Group Tour"}
