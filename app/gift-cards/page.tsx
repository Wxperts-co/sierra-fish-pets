      ...
      <section className="relative overflow-hidden w-full h-[380px] sm:h-[260px] md:h-[420px] [clip-path:inset(0)]">
        ...
        <div className="absolute inset-x-0 top-0 z-[3] flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          >
            ...
            <nav aria-label="breadcrumb" className="flex flex-wrap items-center justify-center gap-0.5 text-sm font-medium text-slate-500">
              <span className="flex items-center gap-0.5">
                <Link href="/" className="text-slate-500 transition-colors duration-150 hover:text-[#00aaff] hover:underline">
                  Home
                </Link>
                <span className="px-0.5 text-slate-400"> › </span>
              </span>
              <span className="font-bold text-[#0d1b2a]">Gift Cards</span>
            </nav>
          </motion.div>
        </div>
      </section>
