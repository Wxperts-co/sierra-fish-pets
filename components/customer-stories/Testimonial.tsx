            ...
            {ENRICHED_REVIEWS.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex flex-col justify-between rounded-2xl bg-[#f0f7ff] border border-blue-100/90 p-5 sm:p-6 shadow-xs hover:shadow-xl hover:border-blue-200 transition-all duration-300 group"
                >
                  <div>
                    ...
                    {item.highlightPhrase && (
                      <div className="mb-3 rounded-xl bg-white/80 border-l-4 border-[#005AA9] p-2.5 text-xs font-semibold text-slate-700 italic">
                        {item.highlightPhrase}
                      </div>
                    )}
